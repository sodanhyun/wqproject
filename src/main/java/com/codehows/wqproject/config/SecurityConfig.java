...
//                            .requestMatchers(new MvcRequestMatcher(introspector, "/auth/**")).permitAll()
                            // DEPLOY
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/question/**")).hasAnyRole("ADMIN", "USER")
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/lecture/**")).hasAnyRole("ADMIN")
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/role/**")).hasRole("ADMIN")
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/favicon.ico")).permitAll()
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/image/**")).permitAll()
                            .requestMatchers(new MvcRequestMatcher(introspector, "/api/common/**")).hasAnyRole("ADMIN", "USER","TEMP")
